...
$$ P_{1}={{I_{1}[МДж/м^2]\cdot10^6\over182[Дни]\cdot24[часы]\cdot3600[секунды]}\cdotS[м^2]} $$
...
$$P_{2}={{I_{2}\cdot10^6\over182\cdot24\cdot3600}\cdotS}$$
...
$P*η*n$={(I_1  +I_2 )*10^6*P_c*S*n)\over(2*182 *24*3600*1000*S)}= =((I_1+I_2  )*P_п*n)/31449,6
