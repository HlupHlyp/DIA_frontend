...
$$E=\sum_{i=1}^k E_{i}^2={\sum_{i=1}^k P\cdotη_{i}\cdot n_{i}}= \sum_{i=1}^k{{I\cdot10^6\cdot P_{c}\cdot S\cdot n}\over{182\cdot24\cdot3600\cdot1000\cdot S}}=\sum_{i=1}^k{I\cdot P_п\cdot n\over15724,8}$$
