...
type Props = Readonly<IPageProps>
type State = Readonly<IPageState>

export class ItemPage extends Component<Props, State> {
  ...
  <div className="space">
    ...
    <BreadCrumbs
      crumbs={[
        ...
        { label: this.props.pageData?.item_name || "Альбом" },
      ]}
    />
